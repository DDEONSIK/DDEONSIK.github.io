...
import { ExternalLink, Github, Layers, Eye, Brain } from 'lucide-react';
                    ...
                    {filteredProjects.map((project) => {
                        ...
                        return (
                            <div key={project.id} className="group bg-card border border-border rounded-2xl overflow-hidden hover-card flex flex-col">
                                {/* Card Header */}
                                <div className="h-48 bg-secondary flex items-center justify-center border-b border-border group-hover:bg-secondary/80 transition-colors">
