...
import { ArrowRight, MapPin, Github, BookOpen, User, Linkedin } from 'lucide-react';
            ...
            <header className="relative z-10 min-h-screen flex items-center justify-center container-custom mb-0">
                <div className="flex flex-col md:flex-row items-center gap-12 w-full">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <div className="flex flex-col gap-6 items-center md:items-start animate-fade-in opacity-0" style={{ animationDelay: '0.4s' }}>
                            ...
                            <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                                {footerData.socialLinks.map((social) => (
                                    <a
                                        ...
                                        className="inline-flex items-center gap-1.5 px-4 py-2.5 bg-background border border-border hover:border-primary hover:text-primary text-foreground text-xs font-semibold rounded-md transition-all shadow-xs hover:shadow hover:-translate-y-0.5"
                                    >
